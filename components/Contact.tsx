    ...
    <section id="contact" className="py-20 md:py-32 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.form
          ...
          className="bg-gradient-to-br from-gray-50 to-white p-6 md:p-8 rounded-xl shadow-lg border border-gray-200"
        >
          <div className="space-y-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full bg-primary-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-primary-700 transition-colors shadow-lg shadow-primary-500/50"
            >
              Send Message
            </motion.button>
          </div>
