...
import { Menu, X, Home, Heart, Activity, BookOpen, Sparkles, Lightbulb, UsersRound } from 'lucide-react'
...
export default function Navigation() {
  ...
  const links = [
    ...
    { href: '/team', label: t('nav.team'), icon: <UsersRound className="w-5 h-5" /> },
  ]
