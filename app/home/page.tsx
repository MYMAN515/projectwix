...
import { Heart, Activity, BookOpen, Sparkles, Lightbulb, Gamepad2, MessageCircle } from 'lucide-react'
...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Get instant support and answers from our AI assistant",
      href: "/chat",
