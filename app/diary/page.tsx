...
export default function DiaryPage() {
  ...
  const moods = [
    { value: 'happy', icon: '😊', label: t('diary.happy'), color: 'from-yellow-400 to-orange-400' },
    { value: 'neutral', icon: '😐', label: t('diary.neutral'), color: 'from-gray-400 to-gray-500' },
    { value: 'sad', icon: '😢', label: t('diary.sad'), color: 'from-blue-400 to-blue-500' },
    { value: 'excited', icon: '🤩', label: t('diary.excited'), color: 'from-pink-400 to-purple-500' },
    { value: 'anxious', icon: '😰', label: t('diary.anxious'), color: 'from-orange-400 to-red-500' },
  ]
    ...
    <div className="container mx-auto px-4 py-8 md:py-12 max-w-4xl">
      ...
      >
        ...
        >
          ...
          {showForm ? (t('diary.addEntry') === 'Add New Entry' ? 'Cancel' : t('diary.addEntry')) : t('diary.addEntry')}
        </motion.button>
      </motion.div>
        ...
        {showForm && (
          ...
          >
            <div className="glass-effect rounded-2xl p-6 md:p-8">
              <h3 className="text-xl font-bold mb-4 text-gray-800">{t('diary.howFeeling')}</h3>
        ...
        <AnimatePresence>
          {entries.length === 0 && !showForm && (
            ...
            >
              ...
              <p className="text-gray-500 text-lg">{t('diary.noEntries')}</p>
            </motion.div>
          )}
      ...
      >
        <h3 className="text-xl font-bold mb-4 text-gray-800">💡 {t('diary.tips')}</h3>
